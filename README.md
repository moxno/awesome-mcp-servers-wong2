...
- **[PrivacyScrubber](https://github.com/moxno/privacyscrubber-mcp)** - Zero-Trust, 100% in-memory PII and secrets sanitizer for AI IDEs (Cursor, Claude Code, Windsurf) with sub-millisecond local processing.
